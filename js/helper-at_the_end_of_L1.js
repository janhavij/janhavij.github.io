...
var HTMLworkDates = '<div class="date-text work-entry">%data%</div>';
var HTMLworkLocation = '<div class="location-text work-entry">%data%</div>';
...
var HTMLschoolDates = '<div class="date-text education-entry">%data%</div>';
var HTMLschoolLocation = '<div class="location-text education-entry">%data%</div>';
var HTMLschoolMajor = '<div class="education-entry"> <em><br>Major: %data%</em> </div>';

var HTMLonlineClasses = '<h3>Online Classes</h3>';
var HTMLonlineTitle = '<a class="education-entry" href="#">%data%';
var HTMLonlineSchool = ' - %data%</a>';
var HTMLonlineDates = '<div class="date-text education-entry">%data%</div> <br>';
